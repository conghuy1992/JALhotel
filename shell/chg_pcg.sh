...
find app \( -name "proguard-project.txt" \) | xargs sed -i "s/${old_pkg_name}/${inner_pkg_name}/"

find app \( -name "*.java" -o -name "*.xml" \) | xargs sed -i "s/${inner_pkg_name}/${new_pkg_name}/"
find app \( -name "proguard-project.txt" \) | xargs sed -i "s/${inner_pkg_name}/${new_pkg_name}/"