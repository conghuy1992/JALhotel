package hotelokura.jalhotels.oneharmony.lib.slidinguppanel;
...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    /**
     * Set the scrim for the child view
     *
     */
    public void setDrawScrim(boolean drawable) {
        mDrawScrim = drawable;
    }
     ...
     *
     */
    public void setSlideRate(float rate) {
        mRate = rate;
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mFirstLayout) {
            mSlideOffset = mCanSlide && mPreservedExpandedState ? 0.0f : 1.0f;
        }
...
//                yStart += (int) ((getMeasuredHeight() - mPanelHeight) * mSlideOffset);
                yStart += (int)(getMeasuredHeight() * (1.0 - mRate)) + (int)(mSlideRange * mSlideOffset);
            } else {
                yStart = nextYStart;
            }
    ...
    public boolean isExpandedEx() {
        return mPreservedExpandedState
                || !mFirstLayout && mCanSlide && mSlideOffset == 0;
    }
...
//        mSlideOffset = (float) (newTop - topBound) / mSlideRange;
        mSlideOffset = (float) (newTop - topBound - (int)(getMeasuredHeight() * (1.0 - mRate))) / mSlideRange;
...
topBound += (int)(getMeasuredHeight() * (1.0 - mRate));
...
top += (int)(getMeasuredHeight() * (1.0 - mRate));
